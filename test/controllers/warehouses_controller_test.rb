...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { quantity: @warehouse.quantity, reason_id: @warehouse.reason_id } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { quantity: @warehouse.quantity, reason_id: @warehouse.reason_id } }
